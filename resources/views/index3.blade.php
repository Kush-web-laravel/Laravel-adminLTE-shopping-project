                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-striped align-middle">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td> <img src="{{asset('adminlte-v4.0.0-beta2-with-dist/dist/assets/img/default-150x150.png')}}" alt="Product 1" class="rounded-circle img-size-32 me-2">
                                                    Some Product
                                                </td>
                                                <td>$13 USD</td>
