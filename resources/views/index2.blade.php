                                        ...
                                        <div class="card-body"> <!-- Conversations are loaded here -->
                                            <div class="direct-chat-messages"> <!-- Message. Default to the start -->
                                                <div class="direct-chat-msg">
                                                    <div class="direct-chat-infos clearfix"> <span class="direct-chat-name float-start">
                                                            ...
                                                            23 Jan 2:00 pm
                                                        </span> </div> <!-- /.direct-chat-infos --> <img class="direct-chat-img" src="{{asset('adminlte-v4.0.0-beta2-with-dist/dist/assets/img/user1-128x128.jpg')}}" alt="message user image"> <!-- /.direct-chat-img -->
                                                ...
                                                <div class="direct-chat-msg end">
                                                    <div class="direct-chat-infos clearfix"> <span class="direct-chat-name float-end">
                                                            ...
                                                            23 Jan 2:05 pm
                                                        </span> </div> <!-- /.direct-chat-infos --> <img class="direct-chat-img" src="{{asset('adminlte-v4.0.0-beta2-with-dist/dist/assets/img/user3-128x128.jpg')}}" alt="message user image"> <!-- /.direct-chat-img -->
                                                    <div class="direct-chat-text">
                                            ...
                                            <div class="direct-chat-contacts">
                                                <ul class="contacts-list">
                                                    <li> <a href="#"> <img class="contacts-list-img" src="{{asset('adminlte-v4.0.0-beta2-with-dist/dist/assets/img/user1-128x128.jpg')}}" alt="User Avatar">
                                                    ...
                                                    <li> <a href="#"> <img class="contacts-list-img" src="{{asset('adminlte-v4.0.0-beta2-with-dist/dist/assets/img/user7-128x128.jpg')}}" alt="User Avatar">
                                                            <div class="contacts-list-info"> <span class="contacts-list-name">
                                                                    Sarah Doe
                                                                    <small class="contacts-list-date float-end">
                                                                        2/23/2023
                                                    ...
                                                    <li> <a href="#"> <img class="contacts-list-img" src="{{asset('adminlte-v4.0.0-beta2-with-dist/dist/assets/img/user3-128x128.jpg')}}" alt="User Avatar">
                                                            <div class="contacts-list-info"> <span class="contacts-list-name">
                                                                    Nadia Jolie
                                                                    <small class="contacts-list-date float-end">
                                                                        2/20/2023
                                                    ...
                                                    <li> <a href="#"> <img class="contacts-list-img" src="{{asset('adminlte-v4.0.0-beta2-with-dist/dist/assets/img/user5-128x128.jpg')}}" alt="User Avatar">
                                                            <div class="contacts-list-info"> <span class="contacts-list-name">
                                                                    Nora S. Vans
                                                                    <small class="contacts-list-date float-end">
                                                                        2/10/2023
                                                    ...
                                                    <li> <a href="#"> <img class="contacts-list-img" src="{{asset('adminlte-v4.0.0-beta2-with-dist/dist/assets/img/user6-128x128.jpg')}}" alt="User Avatar">
                                                            <div class="contacts-list-info"> <span class="contacts-list-name">
                                                                    John K.
                                                                    <small class="contacts-list-date float-end">
                                                                        1/27/2023
                                                    ...
                                                    <li> <a href="#"> <img class="contacts-list-img" src="{{asset('adminlte-v4.0.0-beta2-with-dist/dist/assets/img/user8-128x128.jpg')}}" alt="User Avatar">
                                                            <div class="contacts-list-info"> <span class="contacts-list-name">
                                                                    Kenneth M.
                                                                    <small class="contacts-list-date float-end">
                                                                        1/4/2023
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="row text-center m-1">
                                                <div class="col-3 p-2"> <img class="img-fluid rounded-circle" src="{{asset('adminlte-v4.0.0-beta2-with-dist/dist/assets/img/user1-128x128.jpg')}}" alt="User Image"> <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0" href="#">
                                                        Alexander Pierce
                                                    </a>
                                                ...
                                                <div class="col-3 p-2"> <img class="img-fluid rounded-circle" src="{{asset('adminlte-v4.0.0-beta2-with-dist/dist/assets/img/user7-128x128.jpg')}}" alt="User Image"> <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0" href="#">
                                                        Jane
                                                    </a>
                                                    <div class="fs-8">12 Jan</div>
                                                </div>
                                                <div class="col-3 p-2"> <img class="img-fluid rounded-circle" src="{{asset('adminlte-v4.0.0-beta2-with-dist/dist/assets/img/user6-128x128.jpg')}}" alt="User Image"> <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0" href="#">
                                                        John
                                                    </a>
                                                    <div class="fs-8">12 Jan</div>
                                                </div>
                                                <div class="col-3 p-2"> <img class="img-fluid rounded-circle" src="{{asset('adminlte-v4.0.0-beta2-with-dist/dist/assets/img/user2-160x160.jpg')}}" alt="User Image"> <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0" href="#">
                                                        Alexander
                                                    </a>
                                                    <div class="fs-8">13 Jan</div>
                                                </div>
                                                <div class="col-3 p-2"> <img class="img-fluid rounded-circle" src="{{asset('adminlte-v4.0.0-beta2-with-dist/dist/assets/img/user5-128x128.jpg')}}" alt="User Image"> <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0" href="#">
                                                        Sarah
                                                    </a>
                                                    <div class="fs-8">14 Jan</div>
                                                </div>
                                                <div class="col-3 p-2"> <img class="img-fluid rounded-circle" src="{{asset('adminlte-v4.0.0-beta2-with-dist/dist/assets/img/user4-128x128.jpg')}}" alt="User Image"> <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0" href="#">
                                                        Nora
                                                    </a>
                                                    <div class="fs-8">15 Jan</div>
                                                </div>
                                                <div class="col-3 p-2"> <img class="img-fluid rounded-circle" src="{{asset('adminlte-v4.0.0-beta2-with-dist/dist/assets/img/user3-128x128.jpg')}}" alt="User Image"> <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0" href="#">
                                                        Nadia
                                                    </a>
                                                    <div class="fs-8">15 Jan</div>
                                                </div>
                                ...
                                <div class="card-body p-0">
                                    <div class="px-2">
                                        <div class="d-flex border-top py-2 px-1">
                                            <div class="col-2"> <img src="{{asset('adminlte-v4.0.0-beta2-with-dist/dist/assets/img/default-150x150.png')}}" alt="Product Image" class="img-size-50"> </div>
